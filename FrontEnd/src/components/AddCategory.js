...
const addMsg = " has been successfully added. Add another category or refresh the page to see the changes.";
...
class AddCategory extends Component {
    ...
    render() {
            ...
            return (
                <div className="modal" onClickCapture={this.setModalFalse}>
                    <form className="modal-container" onSubmit={this.handleSubmit} onClickCapture={this.setModalTrue}>
                        ...
                        <input type="submit" value="Add Category" id="posButton" />
        ...
        return (
            <button id="posButton" onClick={() => this.setState({modal: true})}>Add Category</button>
        );
    }
}
